...
public class Jugador extends ObjetoJuego{
	...
	public void inicializarAnimaciones() {
		...
		Rectangle[] CoorrdenadasCaminarAbajo = {
			...
			//	new Rectangle(10,26,54,74),
			//	new Rectangle(10,218,62,74),   //COORDENADAS HACIA ABAJO
			//	new Rectangle(149,122,68,74),
			//	new Rectangle(222,121,68,74),
			//	new Rectangle(291,121,70,74),
			//	new Rectangle(222,121,68,74),
	...
	public boolean verificarColision(ItemAnimado itemAnimado) {	
